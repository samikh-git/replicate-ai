...
| 2   | `BENCHMARK.md` (or extend [test.md](./test.md)) | Table: pack × provider × verdict × runtime × failure tag, regenerated by a script                  |
...
| [DESIGN_TUI.md](./DESIGN_TUI.md)                   | Terminal dashboard UX spec                          |
| [DESIGN_GUI.md](./DESIGN_GUI.md)                   | Browser GUI UX spec                                 |
| [test.md](./test.md)                               | Agent test suite (expected vs actual per pack)      |
